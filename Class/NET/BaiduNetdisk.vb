...
Namespace ShanXingTech.Net2
    ''' <summary>
    ''' 百度网盘类
    ''' 错误信息可以参考： http://developer.baidu.com/wiki/index.php?title=docs/pcs/rest/file_data_apis_error
    ''' 或者参考：http://developer.baidu.com/wiki/index.php?title=docs/pcs/rest/structured_data_apis_error
    ''' </summary>
...
#Region "构造函数区"
        ...
        Sub New(ByRef cookies As CookieContainer, ByVal bdsToken As String, ByVal bdUSS As String)
            ...
            ' 不需要多次设置
            If Not Net2.HttpAsync.IsInitialized Then
                Net2.HttpAsync.Init(cookies)
            End If
...
#Region "函数区"
        ...
        ''' <returns></returns>
        Private Async Function DoPostAsync(ByVal url As String, ByVal postData As String) As Task(Of HttpResponse)
            ...
            Return Await Net2.HttpAsync.PostAsync(url, httpHeadersParam, postData)
        End Function
...
#Region "文件上传"
        ...
        Private Async Function PreCreateFileAsync(ByVal url As String, ByVal postData As String) As Task(Of HttpResponse)
            Return Await DoPostAsync(url, postData)
        End Function
...
#End Region
        ...
        Private Async Function GetFileDownloadLinkAsync(ByVal url As String) As Task(Of String)
           ...
           Async Function()
               Dim json = Await Net2.HttpAsync.GetAsync(url)
        ...
        Public Async Function SearchAsync(ByVal keyword As String) As Task(Of HttpResponse)
            ...
            Return Await Net2.HttpAsync.GetAsync(url, DefaultHttpGetRequestHeader)
        End Function
        ...
        Private Async Function DoDelteAsync(ByVal postData As String, ByVal targetsSerial As String) As Task(Of HttpResponse)
            ...
            ' 提交删除任务
            Dim json = Await DoPostAsync(url, postData)

Namespace ShanXingTech.IO2
    ...
    ''' <summary>
    ''' 获取文件的MIME类(比如，'.txt' 对应的MIME是 'text/plain')
    ''' 经查微软源码，此类支持的文件类型比微软的Web.MimeMapping类多 20170930
    ''' </summary>
...
#End Region
        ...
        Public Shared Function GetMimeType(ByVal fileName As String) As String
            ...
            ' strip off path separators
            ' some MIME types have complex extensions (like ".exe.config"), so we need to work left-to-right
            Dim i As Integer
            While i < fileName.Length
                If fileName(i) = "."c Then
                    ' potential extension - consult dictionary
                    Dim mimeType As String
#Disable Warning BC42030 ' 在为变量赋值之前，变量已被引用传递
                    ' if found return mimeType,else "application/octet-stream"
                    Return If(_mappings.TryGetValue(fileName.Substring(i), mimeType), mimeType, "application/octet-stream")
